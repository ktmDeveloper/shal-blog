      ...
      <div className="container mx-auto">
        ...
        <div className="border-b border-grey-lighter py-16 lg:py-20">
          <div className="flex items-center pb-6">
            <UserCircleIcon className="l-1 h-8 w-8 text-yellow-dark " />
        ...
        <div className="py-16 lg:py-20">
          <div className="flex items-center pb-6">
            <ClipboardDocumentListIcon className="l-1 h-8 w-8 text-yellow-dark " />
            <h3 className="ml-3 font-body text-2xl font-semibold text-primary dark:text-white">
              My Blogs
            </h3>
            <a
            ...
            >
              All posts
              <ArrowLongRightIcon className="ml-1 h-5 w-5 text-green transition-colors hover:text-secondary dark:text-green-light dark:hover:text-secondary" />
            </a>
          </div>
          <div className="pt-8">
        ...
        <div className="pb-16 lg:pb-20">
          <div className="flex items-center pb-6">
            <SparklesIcon className="l-1 h-8 w-8 text-yellow-dark " />
            <h3 className="ml-3 font-body text-2xl font-semibold text-primary dark:text-white">
              My Projects
            </h3>
          </div>
          <div>
            ...
            >
              ...
              <span className="w-1/10">
                <ChevronRightIcon className="mx-auto h-7 w-7 text-primary dark:text-white" />
              </span>
            </a>
